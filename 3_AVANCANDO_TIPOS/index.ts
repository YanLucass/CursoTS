...
const arr1: any = [1, "fkskdfksdf", true, [], {nome: "wht"}];
console.log(arr1);
...
const arr2: (string | number | boolean)[] = [1, "testeee", true, 23, 343, 434];
console.log(arr2);

const arr3: Array<number | string | boolean> = ['Um forcinha', 1, false, 3232, true, 'não'];
console.log(arr3);
...
//vamos adicionar, emobra que pareça que substitutiu
...
type personType = {
    name: string
} // n dá pra fazer o mesmo


//15 literal type

let test: "testando"   //testando é LITERALMENTE um tipo.
...
let maiorGata: "Alane" | "Melinho da rocinha";
